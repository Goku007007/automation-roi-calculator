...
export const TOOLS = {
    ...
    n8n: {
        ...
        currency: 'EUR',
        tiers: [
            { name: 'Starter', executions: 2500, price: 20, billingNotes: 'Billed annually' },
            { name: 'Pro', executions: 10000, price: 50, billingNotes: 'Billed annually' },
            { name: 'Business', executions: 40000, price: 667, billingNotes: 'Billed annually' },
